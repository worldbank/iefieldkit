    ...
    * Use reproot to manage root path
    reproot, project("iefieldkit") roots("clone") prefix("iefieldkit_")
    ...
    * Make sure the version of iefieldkit in the dev environment us up to date with all edits.
    cap net uninstall iefieldkit
    net install iefieldkit, from("${iefieldkit_clone}/src") replace

    ************************
    * Run tests

    * Test basic case of the command ieduplicates
    ieduplicates
