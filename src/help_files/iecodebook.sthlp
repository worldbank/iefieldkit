...
{p 2 4}, {bf:surveys(}{it:Survey1Name} {it:Survey2Name} [...]{bf:)} [{opth gen:erate(varname)}]{p_end}
...
The default behavior is to retain all variables. {bf:Alternatively, to drop variables one-by-one, write "drop" in the "name" column of the codebook.}
Note that this means you cannot name a variable "drop" using {cmdab:iecodebook}.{p_end}
{break}
