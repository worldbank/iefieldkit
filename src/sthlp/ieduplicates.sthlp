...
{hline}
{pstd}help file for {hi:ieduplicates}{p_end}
{hline}

{title:Title}

{phang}{bf:ieduplicates} - This command is used for short description.
{p_end}

{title:Syntax}

{phang}{bf:ieduplicates} , {bf:{ul:opt}ion1}({it:string})
{p_end}
